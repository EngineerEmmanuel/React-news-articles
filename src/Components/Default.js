  ...
  return (
    <main>
      ...
      <div className="search-con">
        <input type="text" Search for any news here value={subTopic} onChange={(e)=>setSubTopic(e.target.value)} />
      ...
      {news.map((newsItem) => (
        ...
        <div className="article-con" key={newsItem.title}>
          ...
          <button><a href={newsItem.source.url} target="_blank" without rel="noreferrer">Read more here </a></button>
